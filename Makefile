#############################################################################
# Makefile for building: ReadEEprom
# Generated by qmake (3.1) (Qt 5.10.1)
# Project:  ReadEEprom.pro
# Template: app
# Command: /home/julien/raspi/qt5/bin/qmake -o Makefile ReadEEprom.pro -spec devices/linux-rasp-pi-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I. -I../raspi/qt5pi/include -I../raspi/qt5pi/include/QtCore -I. -I../raspi/qt5/mkspecs/devices/linux-rasp-pi-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = ReadEEprom1.0.0
DISTDIR = /home/julien/ReadEEprom/.tmp/ReadEEprom1.0.0
...
LIBS          = $(SUBLIBS) -lbcm2835 -lwiringPi -L/home/julien/raspi/qt5pi/lib -lQt5Core -lpthread 
...
DIST          = ../raspi/qt5/mkspecs/features/spec_pre.prf \
		...
		ReadEEprom.pro bcm2835.h main.cpp
QMAKE_TARGET  = ReadEEprom
DESTDIR       = 
TARGET        = ReadEEprom
...
Makefile: ReadEEprom.pro ../raspi/qt5/mkspecs/devices/linux-rasp-pi-g++/qmake.conf ../raspi/qt5/mkspecs/features/spec_pre.prf \
		../raspi/qt5/mkspecs/common/unix.conf \
		../raspi/qt5/mkspecs/common/linux.conf \
		../raspi/qt5/mkspecs/common/sanitize.conf \
		../raspi/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile ReadEEprom.pro -spec devices/linux-rasp-pi-g++ CONFIG+=debug CONFIG+=qml_debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents bcm2835.h $(DISTDIR)/
...
moc_predefs.h: ../raspi/qt5/mkspecs/features/data/dummy.cpp
	/home/julien/raspi/tools/arm-bcm2708/gcc-linaro-arm-linux-gnueabihf-raspbian/bin/arm-linux-gnueabihf-g++ -pipe -marm -mfpu=vfp -mtune=arm1176jzf-s -march=armv6zk -mabi=aapcs-linux -mfloat-abi=hard --sysroot=/home/julien/raspi/sysroot -g -std=gnu++11 -Wall -W -dM -E -o moc_predefs.h ../raspi/qt5/mkspecs/features/data/dummy.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/home/julien/ReadEEprom || mkdir -p $(INSTALL_ROOT)/home/julien/ReadEEprom
	-$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/home/julien/ReadEEprom/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/home/julien/ReadEEprom/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/home/julien/ReadEEprom/ 
